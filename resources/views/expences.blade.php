...
<tr>
    ...
    <th>Date</th>
    <td><input type="date" name="date" id="date" value="{{$date}}" readonly></td>
</tr>
<tr>
    <td></td>
    <td></td>
    <td></td>
    <td> <button  class="btn btn-primary btn-sm" style="margin-left:-95%" onclick="submit()">SUBMIT</button></td>
