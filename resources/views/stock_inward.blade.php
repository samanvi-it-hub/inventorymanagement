...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <br><br><br>
    <small>Note: Select Raw Material,Unite of Measure,Quantity,Cost,date and click insert Button</small>
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    @if($po_line->unit_of_measure==$unit_of_measures->id)         
                    <td>{{$unit_of_measures->Type}}</td>
                    @endif
                    @endforeach
                ...
                @endforeach
                <tr><form method="POST" action="/update-inward">
                    {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="/delete-inward">
                     {{ csrf_field() }}
                     <input type="hidden" id="supplier_id" name="supplier_id" value="{{$po_headers->supplier_id}}">
                    <input type="hidden" id="PO" name="PO" value="{{$po_headers->PO}}">
                    <input type="hidden" id="date" name="date" value="{{$po_headers->date}}">
